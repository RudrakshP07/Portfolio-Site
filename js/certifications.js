...
const DEFAULT_CERTS = [
  ...
  // ── 2026 ──────────────────────────────────────────────
  {id:'cert_29', name:'ISO/IEC 27001:2022 Lead Auditor', issuer:'Mastermind Assurance', year:'2026', category:'Security',
  ...
  {id:'cert_1', name:'Jr. Penetration Tester Path', issuer:'TryHackMe', year:'2026', category:'Security',
  ...
  {id:'cert_2', name:'Cyber Threat Intelligence 101', issuer:'arcX', year:'2026', category:'Security',
   link:'',
  ...
  // ── 2025 ──────────────────────────────────────────────
  {id:'cert_19', name:'CYBERHACK-2025 (2nd Place)', issuer:'MP Police', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_3', name:'Cyber Security Industral Training', issuer:'C9Labs - Pinak Infosec', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_4', name:'Cybersecurity Foundation', issuer:'Palo Alto Networks', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_17', name:'Cybersecurity Job Simulation', issuer:'Deloitte', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_18', name:'Phishing Simulation & Analysis', issuer:'Mastercard', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_7', name:'Introduction to Cyber Security', issuer:'TryHackMe', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_8', name:'PreSecurity Learning Path', issuer:'TryHackMe', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_10', name:'OSForensics Triage Certification', issuer:'PassMark Software', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_11', name:'Cybersecurity Fundamentals Associate (OCFA)', issuer:'OPSWAT', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_12', name:'Introduction to Critical Infrastructure Protection (ICIP)', issuer:'OPSWAT', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_13', name:'File Security Associate (OFSA)', issuer:'OPSWAT', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_14', name:'Email Security Associate (OESA)', issuer:'OPSWAT', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_15', name:'Network Security Associate (ONSA)', issuer:'OPSWAT', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_16', name:'Storage Security Associate (OSSA)', issuer:'OPSWAT', year:'2025', category:'Security',
   link:'',
  ...
  {id:'cert_20', name:'Fundamentals of Deep Learning', issuer:'NVIDIA', year:'2025', category:'Machine Learning',
   link:'',
  ...
  {id:'cert_23', name:'MATLAB Onramp', issuer:'MathWorks', year:'2025', category:'Development',
   link:'',
  ...
  {id:'cert_25', name:'Introduction to IoT', issuer:'NPTEL', year:'2025', category:'Networking',
   link:'',
  ...
  {id:'cert_27', name:'Copyright: FIDDE (Flux Infused Direct Deposition)', issuer:'Government of India', year:'2025', category:'Other',
   link:'',
  ...
  // ── 2024 ──────────────────────────────────────────────
  {id:'cert_9', name:'Ethical Hacking', issuer:'NPTEL', year:'2024', category:'Security',
   link:'',
  ...
  {id:'cert_5', name:'Cybersecurity Essentials', issuer:'Cisco Networking Academy', year:'2024', category:'Security',
   link:'',
  ...
  {id:'cert_6', name:'Introduction to Cybersecurity', issuer:'Cisco Networking Academy', year:'2024', category:'Security',
   link:'',
  ...
  {id:'cert_21', name:'SQL (Basic)', issuer:'HackerRank', year:'2024', category:'Development',
   link:'',
  ...
  {id:'cert_22', name:'SQL (Intermediate)', issuer:'HackerRank', year:'2024', category:'Development',
   link:'',
  ...
  {id:'cert_24', name:'Introduction to Packet Tracer', issuer:'Cisco Networking Academy', year:'2024', category:'Networking',
   link:'',
  ...
  {id:'cert_26', name:'Copyright: URJAA ROOPANTARAN', issuer:'Government of India', year:'2024', category:'Other',
   link:'',
  ...
  {id:'cert_28', name:'Techathon 1.0', issuer:'Technical Competition', year:'2024', category:'Other',
   link:'',
